...
public class GoogleCredentialsService {
    ...
    public GoogleCredentials getValidCredentials(String email) throws IOException {
        String accessToken =
                googleAccessTokenCacheService.getAccessToken(ACCESS_TOKEN_PREFIX + email);
        long expiresInSeconds =
                googleAccessTokenCacheService.getExpiresInSeconds(ACCESS_TOKEN_PREFIX + email);
        ...
        googleAccessTokenCacheService.addAccessToken(
                email, response.getAccessToken(), response.getExpiresInSeconds(), TimeUnit.SECONDS);
